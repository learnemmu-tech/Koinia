...
export const worshipContentCardClassName =
  "app-interactive app-interactive-lift app-mobile-card group flex h-[340px] flex-col overflow-hidden rounded-xl border border-border/50 bg-card/40 transition-all duration-200 hover:-translate-y-1 hover:border-border/80 hover:bg-card/60 hover:shadow-lg hover:shadow-black/20";
